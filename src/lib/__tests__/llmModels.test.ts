...
function makeModel(overrides: Partial<ModelConfig> = {}): ModelConfig {
  return {
    ...
    hosting: overrides.hosting ?? { mode: 'local' as const, model_path: '', flash_attention: true, ctx_size: 32768, cache_type_k: 'q8_0', cache_type_v: 'q8_0', n_gpu_layers: 99, cpu_moe: false, n_cpu_moe: null, cache_ram: null, threads: null, parallel: 1, port: 8081, cuda_visible_devices: null, auto_start: false, auto_restart: false, extra_flags: [] },
