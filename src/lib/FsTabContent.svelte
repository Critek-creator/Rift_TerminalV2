...
<style>
  ...
  .strip {
    ...
    display: flex; align-items: center; gap: 14px;
    background: linear-gradient(to bottom, rgba(111, 224, 224, 0.04), transparent);
    color: var(--amber-dim);
    font-size: 10px;
    letter-spacing: 0.1em;
    overflow: hidden;
  ...
  .strip-event {
    ...
    white-space: nowrap;
    background: rgba(111, 224, 224, 0.04);
    flex-shrink: 0;
  }
  ...
  .filepath { overflow: hidden; text-overflow: ellipsis; color: var(--amber-warm); font-size: 10px; }
