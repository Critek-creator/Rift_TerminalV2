...
pub use config::{
    CockpitConfig, DetachedPos, ErrorHandoffConfig, ErrorHandoffMode, FsConfig, IndexDensity,
    IndexLabelVisibility, McpConfig, NotifFilterConfig, ProjectEntry, RiftConfig, SeverityLevel,
    ShellPref, StatusLineConfig, TerminalConfig, TreeConfig, TERMINAL_DEFAULT_FONT_FAMILY,
